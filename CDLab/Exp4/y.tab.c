...
{
      14,     0,    -1,     3,     9,    15,    10,    -1,    15,     5,
      15,    -1,    15,     6,    15,    -1,    15,     7,    15,    -1,
      15,     8,    15,    -1,    11,    15,    12,    -1,     3,    -1,
       4,    -1
};
...
#line 35 "tac.y"
    { 
                              char lhs[2] = { (yyvsp[(1) - (4)].symbol), '\0' };
                              addtotable(lhs, (yyvsp[(3) - (4)].str), '=');
                           }
    break;
...
/* Line 1455 of yacc.c  */
#line 42 "tac.y"
    { (yyval.str) = addtotable((yyvsp[(1) - (3)].str), (yyvsp[(3) - (3)].str), '+'); }
    break;
...
#line 47 "tac.y"
    { 
                        char *buf = malloc(2);
                        buf[0] = (yyvsp[(1) - (1)].symbol); buf[1] = '\0';
                        (yyval.str) = buf;
                     }
    break;
